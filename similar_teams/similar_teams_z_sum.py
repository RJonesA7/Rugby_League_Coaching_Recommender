...
#Function which takes in a stat_dict representing an opposition team and returns a dataframe with the most similar teams in the database and a total z-score difference show how similar they are
def similar_teams_z_sum(stats_dict, num_of_matches):
...
teams = similar_teams_z_sum({"time_in_possession": 1, "average_play_ball_speed": -1, "completion_rate": 1}, 10)
